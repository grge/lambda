...
var _grge$lambda$Lambda$toText = function (term) {
	var _p0 = term;
	switch (_p0.ctor) {
		case 'VarTerm':
			return _p0._0.name;
			...
			return A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'.',
						_grge$lambda$Lambda$toText(_p1.body))));
		default:
			var _p2 = _p0._0;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_grge$lambda$Lambda$toText(_p2.lambda),
					A2(
						_elm_lang$core$Basics_ops['++'],
						')(',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_grge$lambda$Lambda$toText(_p2.argument),
							')'))));
	}
};
...
var _grge$lambda$Lambda$Application = F2(
	function (a, b) {
		return {lambda: a, argument: b};
	});
var _grge$lambda$Lambda$ApplicationTerm = function (a) {
	return {ctor: 'ApplicationTerm', _0: a};
};
...
var _grge$lambda$Tokenizer$Token = F2(
	function (a, b) {
		return {index: a, string: b};
	});
var _grge$lambda$Tokenizer$makeToken = function (match) {
	return A2(_grge$lambda$Tokenizer$Token, match.index, match.match);
};
var _grge$lambda$Tokenizer$tokenize = function (str) {
	var rx = _elm_lang$core$Regex$regex('[.\\\\\\λ\\(\\)]|((\\w|\\\')+)');
	return A2(
		_elm_lang$core$List$map,
		_grge$lambda$Tokenizer$makeToken,
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, rx, str));
};

var _grge$lambda$Parser$parseOk = F2(
	function (term, rest) {
		return _elm_lang$core$Result$Ok(
			{ctor: '_Tuple2', _0: term, _1: rest});
	});
var _grge$lambda$Parser$ParseError = F2(
	function (a, b) {
		return {position: a, message: b};
	});
var _grge$lambda$Parser$parseErr = F2(
	function (ix, text) {
		return _elm_lang$core$Result$Err(
			A2(_grge$lambda$Parser$ParseError, ix, text));
	});
var _grge$lambda$Parser$parseVarTerm = function (tokens) {
	var _p0 = tokens;
	if (_p0.ctor === '::') {
		var _p1 = _p0._0;
		var rx = _elm_lang$core$Regex$regex('^(\\w|\\\')+$');
		return A2(_elm_lang$core$Regex$contains, rx, _p1.string) ? A2(
			_grge$lambda$Parser$parseOk,
			_grge$lambda$Lambda$VarTerm(
				_grge$lambda$Lambda$Var(_p1.string)),
			_p0._1) : A2(
			_grge$lambda$Parser$parseErr,
			_p1.index,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Bad variable name (',
				A2(_elm_lang$core$Basics_ops['++'], _p1.string, ')')));
	} else {
		return A2(_grge$lambda$Parser$parseErr, 0, 'Couldn\'t parse VarTerm from no tokens');
	}
};
var _grge$lambda$Parser$parseLambdaTerm = function (tokens) {
	var _p2 = tokens;
	if (_p2.ctor === '::') {
		if ((_p2._1.ctor === '::') && (_p2._1._1.ctor === '::')) {
			var _p6 = _p2._0;
			var _p5 = _p2._1._0;
			if ((_elm_lang$core$Native_Utils.eq(_p6.string, 'λ') || _elm_lang$core$Native_Utils.eq(_p6.string, '\\')) && _elm_lang$core$Native_Utils.eq(_p2._1._1._0.string, '.')) {
				var _p3 = _grge$lambda$Parser$parseVarTerm(
					{
						ctor: '::',
						_0: _p5,
						_1: {ctor: '[]'}
				...
				if (_p3.ctor === 'Ok') {
					var _p4 = _grge$lambda$Parser$parseTerm(_p2._1._1._1);
					if (_p4.ctor === 'Ok') {
						return A2(
							_grge$lambda$Parser$parseOk,
							_grge$lambda$Lambda$LambdaTerm(
								A2(
									_grge$lambda$Lambda$Lambda,
									_grge$lambda$Lambda$Var(_p5.string),
									_p4._0._0)),
							_p4._0._1);
					} else {
		...
		return A2(_grge$lambda$Parser$parseErr, 0, 'Can\'t parse LambdaTerm out of no tokens');
	}
};
var _grge$lambda$Parser$parseTerm = function (tokens) {
	var _p7 = _grge$lambda$Parser$parseSimpleTerm(tokens);
	if (_p7.ctor === 'Ok') {
		var _p10 = _p7._0._0;
		var _p9 = _p7._0._1;
		var _p8 = _p9;
...
var _grge$lambda$Parser$completeApplication = F2(
	function (term, tokens) {
		var _p11 = _grge$lambda$Parser$parseTerm(tokens);
		if (_p11.ctor === 'Ok') {
			return A2(
				_grge$lambda$Parser$parseOk,
				_grge$lambda$Lambda$ApplicationTerm(
					A2(_grge$lambda$Lambda$Application, term, _p11._0._0)),
				_p11._0._1);
		} else {
...
var _grge$lambda$App$onKeyPress = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keypress',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$keyCode));
};
var _grge$lambda$App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var result = _grge$lambda$Parser$parseTerm(
			_grge$lambda$Tokenizer$tokenize(_p0._0));
		var _p1 = result;
		if (_p1.ctor === 'Ok') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					output: _grge$lambda$Lambda$toText(
						_grge$lambda$Lambda$reduce(_p1._0._0))
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{output: _p1._0.message});
		}
	});
var _grge$lambda$App$model = {input: '', output: ''};
var _grge$lambda$App$Model = F2(
	function (a, b) {
		return {input: a, output: b};
	});
var _grge$lambda$App$Change = function (a) {
	return {ctor: 'Change', _0: a};
};
var _grge$lambda$App$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('λ-CALCULUS'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('λ-calculus interpreter written in javascript — backslash \\ inserts a lambda'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('labeled-box'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('\\x.x'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_grge$lambda$App$Change),
												_1: {ctor: '[]'}
											}
										}
									},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('parse-error-box'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
...
var _grge$lambda$App$main = _elm_lang$html$Html$beginnerProgram(
	{model: _grge$lambda$App$model, view: _grge$lambda$App$view, update: _grge$lambda$App$update})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _grge$lambda$App$main !== 'undefined') {
    _grge$lambda$App$main(Elm['App'], 'App', undefined);
}
